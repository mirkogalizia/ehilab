...
export async function POST(req) {
  try {
    ...
    // >>>> PRENDI DATI WHATSAPP DAL DOCUMENTO UTENTE
    ...
    // LOG utile
    console.log("[order-fulfilled] Dati WhatsApp:", { template_name, phone_number_id, access_token, user_uid });

    if (!template_name || !phone_number_id || !access_token) {
      console.error("[order-fulfilled] Dati WhatsApp mancanti", { template_name, phone_number_id, access_token, user_uid });
    ...
    console.error("[order-fulfilled] ERRORE:", err);
